...
def roll_dice(dice_pool):
    ...
    """
    dice_faces = {
        "ability": ["success", "advantage", "success+advantage",
                    "success+success",
                    "advantage", "success", "advantage+advantage", "blank"],
        "proficiency": [
                        "advantage+advantage",
                        "advantage",
        ...
        "challenge": ["threat+threat",
                      ...
                      "failure+failure",
                      "blank"],
        "boost": ["blank", "blank", "success", "success+advantage",
                  "advantage+advantage",
                  "advantage"],
        "setback": ["blank", "blank",
                    "failure", "failure",
                    "threat", "threat"],
        "force": ["dark", "dark", "dark", "dark",
                  "dark", "dark", "dark+dark",
